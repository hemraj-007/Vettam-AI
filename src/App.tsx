...
const App: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen relative overflow-hidden">
      {/* Animated Background */}
      <div className="fixed inset-0 bg-gradient-to-br from-purple-900 via-red-900 to-orange-800">
        <div className="absolute inset-0 bg-gradient-to-tr from-purple-800/50 via-transparent to-orange-600/30"></div>
        ...
        <div className="absolute top-0 right-0 w-full h-full overflow-hidden">
          <div className="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-br from-orange-400/30 to-red-600/30 rounded-full blur-2xl animate-spin-slow"></div>
